...
function Home() {
   ...
   * Home → Register
   *
   * Authenticated + fully verified landlord:
   * Home → Add Property
   *
   * Authenticated but not eligible:
   * Home → Add Property
   *
   * The last case is intentionally allowed to reach
   * ProtectedRoute, which will decide whether the user
   * needs another step such as verification.
   *
   * We do NOT bypass ProtectedRoute here.
   */
  const handleAddProperty = () => {
    ...
    if (isLandlord && isFullyVerified) {
      navigate("/add-property");
      return;
    }

    /*
     * Let ProtectedRoute handle authenticated users
     * who are not currently eligible.
     *
      ...
      <div className="home-container">
        ...
        >
          ...
          <button
            ...
            onClick={() =>
              alert(
                "Map screen will be connected in the next step."
              )
            }
          >
            <MapPin size={20} />
          ...
          <button
            ...
            onClick={() =>
              alert(
                "Saved properties will be connected next."
              )
            }
          >
            <Heart size={20} />
