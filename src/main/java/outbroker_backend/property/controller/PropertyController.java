...
public class PropertyController {
    ...
    public ResponseEntity<ApiResponse<List<PropertyResponse>>> filterProperties(
        ...
        outbroker_backend.property.dto.PropertySearchCriteria criteria = new outbroker_backend.property.dto.PropertySearchCriteria();
    ...
    public ResponseEntity<ApiResponse<PropertyResponse>> updateProperty(
        ...
        Property updatedProperty = propertyService.updateProperty(id, updatedDetails);
