...
public class ReviewService {
    ...
    @Transactional
    public ReviewResponse addReview(UUID tenantId, UUID propertyId, ReviewRequest request) {
        if (reviewRepository.existsByTenantIdAndPropertyId(tenantId, propertyId)) {
    ...
    @Transactional(readOnly = true)
    public PropertyRatingSummary getPropertyRatingSummary(UUID propertyId) {
        ...
        return new PropertyRatingSummary(propertyId, finalAvg, count);
    }
